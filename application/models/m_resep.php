...
class M_resep extends CI_Model {
    ...
    function kitir_load_data($id_resep = NULL) {
        ...
        $sql = "select pj.ppn, pj.total, pj.bayar, pj.pembulatan, rr.resep_id, td.transaksi_id, b.hna, td.hpp, pj.bayar, pj.id as id_penjualan, rrr.pakai_jumlah as keluar, td.ed, bp.id as id_pb, bp.barcode, bp.margin, bp.diskon, b.nama as barang, st.nama as satuan_terkecil, bp.isi, 
    ...
    function nota_load_data($id_resep = NULL) {
        ...
        $sql = "select pj.ppn, rs.id as resep_id, pj.tuslah, pj.total, pj.bayar, pj.pembulatan, td.transaksi_id, b.hna, td.hpp, pj.bayar, pj.id as id_penjualan, td.keluar, td.ed, bp.id as id_pb, bp.barcode, bp.margin, bp.diskon, b.nama as barang, st.nama as satuan_terkecil, bp.isi, 
            o.kekuatan, r.nama as pabrik, td.jual_diskon_percentage, td.h_jual, td.subtotal, pdd.member as diskon_member, s.nama as satuan, sd.nama as sediaan, pdk.nama as pegawai, pdd.nama as pasien, pdd.nama, rs.pasien_penduduk_id
            from penjualan pj
