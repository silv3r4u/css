...
<tr class=rows>
    ...
    <td><input type=text name=isi[] size=10 class=isi_nb id=isi_nb<?= $key ?> onkeyup="set_harga_jual_nb(<?= $key ?>);" style="min-width: 100px;" value="<?= $data->isi ?>" /></td>
    ...
    <td align="center"><input type=text name=margin[] size=5 onkeyup="set_harga_jual_nb(<?= $key ?>);" id="margin_nb<?= $key ?>" style="min-width: 50px;" value="<?= $data->margin ?>" /></td>
    <td align="center"><input type=text name=diskon[] size=5 onkeyup="set_harga_jual_nb(<?= $key ?>);" id="diskon_nb<?= $key ?>" style="min-width: 50px;" value="<?= $data->diskon ?>" /></td>
    <td align="right" id="hj<?= $key ?>"><input type=text name=harga_jual[] size=5 onblur="FormNum(this);" value="<?= rupiah($harga_jual) ?>" onkeyup="set_margin_nb(<?= $key ?>);" style="min-width: 50px;" id=harga_jual_nb<?= $key ?> /></td>
