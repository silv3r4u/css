<div class="data-list">
    ...
    <table class="tabel" width="100%">
        ...
        foreach ($list_data as $key => $data) {
            ...
            <tr class="even">
                ...
                <td align="center"><b>Packing Barang</b></td>
    ...
    <table class="tabel" width="100%">
        ...
        ?>
        <tr class="even"><td colspan="5" align="center">Total</td><td align="right"><?= rupiah($totallica) ?></td></tr>
    </table>
    <script>
        $(function() {
    ...
    <table class="tabel" width="100%">
        ...
        foreach ($rawat_inap as $nooo => $rowy) {
            ...
            <?php
            $totallicas = $totallicas + $rowy->subtotal;
        }
        ?>
        <tr class="even"><td colspan="5" align="center">Total</td><td align="right"><?= rupiah($totallicas) ?></td></tr>
    </table>
    <script>
        $(function() {
